...
DEFINITOINS = {
    ...
    'тестирование': 'поиск несоответствия между фактическим и ожидаемым поведением',
    'rest': 'архитектурный стиль, к нему не применяются жёсткие правила (он не правилозависимый). В его написании используется JSON',
    ...
    'soap': ' (Simple object access protocol) протокол обмена структурированными сообщениями. в распределённой вычислительной среде. Этот протокол используется для обмена произвольными сообщениями в формате XML',
    'json': ' (англ. JavaScript Object Notation) текстовый формат обмена данными, основанный на JavaScript. Но при этом формат независим от JS и может использоваться в любом языке программирования',
    'xml': ' (англ eXtensible Markup Language) расширяемый язык разметки. Используется для хранения и передачи данных'
}
